...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('TimeApp', '0004_alter_lot_cooling_time_alter_lot_end_extruder_time_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='lot',
            name='cooling_time',
            field=models.DateTimeField(default=datetime.datetime(2022, 7, 18, 14, 57, 23, 344855), null=True),
        ),
        migrations.AlterField(
            model_name='lot',
